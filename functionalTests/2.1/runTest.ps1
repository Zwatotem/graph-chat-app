...
# $out1|Out-CurrentFile
# $out2|Out-CurrentFile
return `
	$out1.LastIndexOf(("message1")) -gt $out1.IndexOf(("message1")) -and `
	$out1.LastIndexOf(("message2")) -ge $out1.IndexOf(("message2")) -and `
	$out2.LastIndexOf(("message1")) -ge $out2.IndexOf(("message1")) -and `
	$out2.LastIndexOf(("message2")) -gt $out2.IndexOf(("message2"))